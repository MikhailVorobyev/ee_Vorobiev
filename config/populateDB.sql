...
VALUES ('admin', 'John', 'Smith', 'admin123', 'г.Тверь', '2345',  2000, 15),
       ('user1', 'userFirstName1', 'userLastName1', 'password1', 'г.Тверь', '2345', 2000, 10),
       ('user2', 'userFirstName2', 'userLastName2', 'password2', 'г.Тверь', '2345', 2000, 8),
       ('user3', 'userFirstName3', 'userLastName3', 'password3', 'г.Тверь', '2345', 2000, 6),
       ('user4', 'userFirstName4', 'userLastName4', 'password4', 'г.Тверь', '2345', 2000, 5),
       ('user5', 'userFirstName5', 'userLastName5', 'password5', 'г.Тверь', '2345', 2000, 3);
